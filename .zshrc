...
zstyle    ':z4h:ssh:*' send-extra-files '~/.zshenv-private' '~/.zshrc-private' '~/.config/htop/htoprc' '~/.proxy.conf' '~/.bashrc' '~/.bash_profile' '~/.bash_aliases' '~/.gitconfig' '~/.vimrc' '~/.config/tmux/tmux.conf' '~/.config/tmux/tmux.min.conf' '~/.config/tmux/tmux.fancy.conf' '~/.ssh/environment' '~/bin' '~/dotfiles'
